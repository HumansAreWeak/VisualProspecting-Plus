...
public class Tags {
    ...
    public static final String MODID = "visualprospecting-plus";
    public static final String MODNAME = "VisualProspecting Plus";
    public static final String VERSION = "unknown";
    public static final String GROUPNAME = "de.humansareweak.visualprospectingplus";
